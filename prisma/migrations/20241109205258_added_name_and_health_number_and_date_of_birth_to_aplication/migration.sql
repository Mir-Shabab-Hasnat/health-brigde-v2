/*
  ...
  - Added the required column `healthNumber` to the `Application` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Application" ("createdAt", "id", "issue", "medications", "patientId", "severity", "status", "symptoms", "updatedAt") SELECT "createdAt", "id", "issue", "medications", "patientId", "severity", "status", "symptoms", "updatedAt" FROM "Application";
